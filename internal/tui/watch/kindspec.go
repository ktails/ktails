...
type kindSpec struct {
	watch    func(c Cluster) func(ctx context.Context, kubeContext, namespace, resourceVersion string) (watch.Interface, error)
	list     func(c Cluster) func(ctx context.Context, kubeContext, namespace string) ([]metav1.Object, string, error)
	newCache func() rowCache
}

var kindSpecs = map[msgs.ResourceKind]kindSpec{
	msgs.KindPods: {
		watch: func(c Cluster) func(context.Context, string, string, string) (watch.Interface, error) {
			return c.WatchPods
		},
		list: func(c Cluster) func(context.Context, string, string) ([]metav1.Object, string, error) {
			return func(ctx context.Context, kubeContext, namespace string) ([]metav1.Object, string, error) {
